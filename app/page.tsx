    ...
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        <header className="mb-6 pb-6 border-b border-gray-200 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
          ...
          <div className="bg-gray-100 text-gray-600 px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 shadow-inner w-fit">
            <span className="text-lg">👤</span> Device Profile: {userId.substring(0, 6)}...
          </div>
        </header>
